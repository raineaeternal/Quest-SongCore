...
#include "CustomBeatmapLevelPackCollection.hpp"
...
DECLARE_CLASS_CODEGEN_INTERFACES(SongCore::SongLoader, RuntimeSongLoader, System::Object, std::vector<Il2CppClass*>({classof(Zenject::IInitializable*), classof(System::IDisposable*)}),
    ...
    public:
        ...
        __declspec(property(get = get_CustomBeatmapLevelPackCollection)) CustomBeatmapLevelPackCollection* CustomBeatmapLevelPackCollection;
